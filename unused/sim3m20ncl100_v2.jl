...
@everywhere function sim3m20ncl100(seed)
    ...
    rmse0 = norm(res0.meanfunest - meanfun)/sqrt(100*3*20)
    ...
    rmse01 = norm(res01.meanfunest - meanfun)/sqrt(100*3*20)
    ...
    rmse1 = norm(res1.meanfunest - meanfun)/sqrt(100*3*20)
    estpc1 = index1[2]
...
writedlm("resultnew_v2/resultsim3m20ncl100.csv", resultsim3m20ncl100, ',')
