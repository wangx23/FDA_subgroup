...
data3s30_v3 = zeros(4320,5,100)

for i = 1:100
    datai = simdat3s_v3(sig2, lamj, group, m = m,seed = i)
    data3s30_v3[:,1,i] = datai.group
    data3s30_v3[:,2,i] = datai.ind
    data3s30_v3[:,3,i] = datai.time
    data3s30_v3[:,4,i] = datai.obs
    data3s30_v3[:,5,i] = datai.meanfun
end
