...
@everywhere include("simdat3s_v6.jl")
...
@everywhere function sim3s20_v6(seed::Int64)
    ...
    data = simdat3s_v6(sig2, lamj, group, m = m,seed = seed)
...
resultsim3s20_v6 = pmap(sim3s20_v6, 1:100)
writedlm("../resultnew_v2/resultsim3s20_v6.csv", resultsim3s20_v6, ',')
