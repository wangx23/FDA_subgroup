...
@everywhere function sim3m30(seed::Int64)
    ...
    rmse0 = norm(res0.meanfunest - meanfun)/sqrt(150*30)
    ...
    rmse01 = norm(res01.meanfunest - meanfun)/sqrt(150*30)
    ...
    rmse3 =  norm(refit3.meanfunest- meanfun)/sqrt(150*30)
...
writedlm("resultnew_v2/resultsim3m30.csv", resultsim3m30, ',')
