...
@everywhere function sim3m20(seed::Int64)
    ...
    rmse0 = norm(meanfunest0 - meanfun)/sqrt(150*20)
    ...
    rmse01 = norm(meanfunest01 - meanfun)/sqrt(150*20)
...
writedlm("../resultnew_v4/resultsim3m20.csv", resultsim3m20, ',')
